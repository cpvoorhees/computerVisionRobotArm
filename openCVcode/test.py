...
def stereo_calibrate(mtx1, dist1, mtx2, dist2, frames_folder):
    ...
    for frame1, frame2 in zip(c1_images, c2_images):
        ...
        if c_ret1 == True and c_ret2 == True:
            ...
            cv.drawChessboardCorners(frame1, (5,7), corners1, c_ret1)
            cv.imshow('img', frame1)
 
            cv.drawChessboardCorners(frame2, (5,7), corners2, c_ret2)
...
R1, R2, P1, P2, Q, validPixROI1, validPixROI2 = cv.stereoRectify(mtx1, dist1,mtx2, dist2,(width,height), R, T,flags=cv.CALIB_ZERO_DISPARITY,alpha=0)
